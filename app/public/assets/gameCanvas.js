    ...
    */
    ...
    showCountdown(callback) {
        ...
        const showNumber = () => {
            ...
            this.renderingContext.textBaseline = 'middle';
            if (count > 0) {
                this.renderingContext.fillText(count.toString(), this.canvas.width / 2, this.canvas.height / 2);
            }
            else {
                this.renderingContext.fillStyle = '#00ff00';
                this.renderingContext.fillText('GO!', this.canvas.width / 2, this.canvas.height / 2);
            }
            count--;
            if (count >= 0) {
